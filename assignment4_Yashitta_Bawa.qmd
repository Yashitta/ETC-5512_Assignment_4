...
subtitle: "ETC-5512 Assignment 4"
...
These datasets were selected because they are **publicly available**, include the **relevant variables** needed to address the research question, and are **up-to-date** as of 2023.
...
**1. Genre Breakdown: Most Watched Categories Overall**
...
Parts of this project, including text refinement, paraphrasing, and grammar correction, were supported by OpenAI’s ChatGPT. The AI was used to enhance clarity, coherence, and flow in the written sections, while all core ideas, analyses, and interpretations remain the original work of the author. Here is the link for the [ChatGPT Query.](https://chatgpt.com/share/68502201-27d0-800c-8cb0-023fc4eb1f2d)
...
### 🧹 Genre Cleaning and Duration Understanding
...
The dataset only had total viewing hours, with no extra context like how many people actually finished the show or where people were watching from. So, it was pretty hard to tell if high engagement meant the show was really popular, super rewatchable, or just pushed a lot by Netflix’s algorithm. In future work, it’d help to bring in other data—like country-wise trends, how many viewers watched till the end, or even IMDb ratings—to get a better idea of *why* certain titles did well.
...
In addition to the GitHub repository, the four iterative `.qmd` files referenced above have also been included separately in this submission to document the version history.
:::
